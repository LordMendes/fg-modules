...
Generated: 2026-07-14 02:55 UTC

Target: Fantasy Grounds **3.5E** ruleset load + automation conventions (per `fg-builder/skills/`).
...
| Variant classes missing skill automation | Manual L1 skill selection | Improve scrape for variant class pages; see also `variants/unearthed-arcana.md` |
| Unearthed Arcana class variants | 50 classes scraped (variants + alternate builds); many lack skill automation | Expected for UA; manual L1 skill selection in FG |

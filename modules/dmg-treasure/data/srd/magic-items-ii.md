SRD 3.5 > Equipment and Gear > Magic Items II
...
Frost Brand: This +3 frost greatsword sheds light as a torch when the temperature drops below 0°F. At such times it cannot be cconcealedwhen drawn, nor can its light be shut off. Its wielder is protected from ffire the sword absorbs the first 10 points of ffiredamage each round that the wielder would otherwise take.
